...
## TEMA ELEGIDO
El desarrollo de un modelo predictivo utilizando el algoritmo de Random Forest, con la capacidad de predecir si un estudiante abandonara los estudios el siguiente cilo universitario.
